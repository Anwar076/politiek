    ...
    <div class="flex min-h-screen">
        <aside class="w-56 bg-marine-dark border-r border-white/10 flex flex-col">
            ...
            <nav class="p-4 space-y-1">
                ...
                <a href="{{ route('admin.donations.index') }}" class="block py-2 text-white/80 hover:text-accent">Donaties</a>
                <a href="{{ route('admin.volunteers.index') }}" class="block py-2 text-white/80 hover:text-accent">Vrijwilligers</a>
            </nav>
